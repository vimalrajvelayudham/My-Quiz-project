...
const quizQuestions = [
  {
    question: "What is your facourite Anime Name?",
    answers:[
    { text: "Dragon-Ball",correct:false},
    { text: "Attack-On_Titan",correct: false},
    {text: "One-Piece",correct: true},
    {text: "Demon-Slayer",correct: false},
    ],
},
 {
   question:"who is your favourite anime Main-character?",
   answers:[
...
},
  {
   ...
   answers:[
    { text: "Beef-Biriyani",correct:false},
    { text: "prawn-Fry",correct: false},
    {text: "Ramen",correct: true},
    {text: "Beef-Burger",correct: false},
   ],
},
  {
   question:"what is your favourite game?",
